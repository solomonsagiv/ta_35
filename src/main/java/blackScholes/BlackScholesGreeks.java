...
public class BlackScholesGreeks {
	...
	public static OptionGreeks calculate(OptionDetails req) {
		...
		double[] array = calculate(req.callOption, req.spotPriceOfUnderlying, req.strikePrice, req.riskFreeInterestRate,
				req.timeToExpire, req.volatility);
	...
	public static double[] calculate(boolean c, double s, double k, double r, double t, double v) {
